...
if speed < 0 or speed > 10:
  raise Exception("Speed 0-10")

window=turtle.Screen()
window.bgcolor("#4a633a")
...
#startplayer position, and more
playerx = playery = 3
boxes = 7
haswon = 0

#Box checker and game win checker
def boxcheck():
...
def win():
  ...
  print("Congrats Githubber? You didnt break the system!")
  if haswon == 0:
    haswon = 1
    winner.speed(speed)
    winner.up()
    winlist = ["C","O","N","G ","R","A","T","S"]
    for o in range(8):
      if o == 0:
